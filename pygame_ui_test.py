...
gameDisplay = pygame.display.set_mode(
    (display_width, display_height))  # initialize screen
...
def bar(x, y, w, h, color_init, color_border, color_bg=white, border_thickness=1, percent=100, msg=None):
    ...
    pygame.draw.rect(gameDisplay, color_border, (x - border_thickness, y -
                                                 border_thickness, w + (border_thickness * 2), h + (border_thickness * 2)))
...
def value_bar(x, y, w, h, value, max_value, color_init, color_border, color_bg, border_thickness=1):
    ...
    bar(x, y, w, h, color_init, color_border,
        color_bg, border_thickness, percent, msg)

def drawMap(coord):
    pygame.draw.rect(gameDisplay,black,(48,78,447,334),2)
    pygame.draw.rect(gameDisplay,green,(48,78,447,334))
